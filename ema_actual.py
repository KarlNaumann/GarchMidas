...
def boundsFull():
    """ Generate bounds
        Order of variables: mu,  a0,  a1,  b0,  b1,  g0,  g1,   m,   theta,w1, w2, p0, p1
    """
...
def boundsUncond():
    """ Generate bounds objects
        Order of variables: mu, a0_0, a0_1, a, b, g, theta, w1, w2, p0, p1
    """
    # Restricted case lb & ub
...
def boundsGARCH():
    """ Generate bounds for the GARCH(1,1) model
        Order of the variables: mu,  a0,  a1,  a,  b1,  g0, p0, p1
    """
...
def filterProbability(p00, p11, f0, f1):
...
def smoothProbability(p00, p11, fore, inf):
...
def llfHaasUncond(p, args):
    ...
    if np.isnan(llfunction) or np.isinf(llfunction):
        llfunction = -9e15
    return -llfunction
